...
#region Section -> FPS
            ...
            if (m_fpsModuleInspectorToggle)
            {
                ...
                if ((m_goodFpsThreshold.intValue <= m_cautionFpsThreshold.intValue) &&
                    (m_goodFpsThreshold.intValue > 1))
                {
...
#region Section -> Audio
            ...
            if (m_audioModuleInspectorToggle)
            {
                ...
                {
                    var newDistance = Mathf.Abs(m_spectrumSize.intValue - m_spectrumSizeValues[i]);
...
#region Section -> Advanced Settings
            ...
            if (m_advancedModuleInspectorToggle)
            {
                ...
                EditorGUILayout.PropertyField(
                    ...
                    new GUIContent("Module state", "FULL -> Text \nOFF -> Turned off")
                );
            }
...
#region Variables -> Private
        ...
        private readonly int[] m_spectrumSizeValues = {128, 256, 512, 1024, 2048, 4096, 8192};
