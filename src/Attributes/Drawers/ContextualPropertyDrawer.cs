...
namespace Appalachia.Editing.Attributes.Drawers
{
    public abstract class
        ContextualPropertyDrawer<TAttribute, TContext> : OdinAttributeDrawer<TAttribute>
    ...
    public abstract class
        ContextualPropertyDrawer<TAttribute, TContext, TValue> : OdinAttributeDrawer<TAttribute,
            TValue>
        where TAttribute : Attribute
        where TContext : PropertyDrawerContextCollection<TAttribute>, new()
    {
