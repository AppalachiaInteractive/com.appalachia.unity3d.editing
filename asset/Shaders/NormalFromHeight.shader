...
Shader "appalachia/utility/NormalFromHeight" 
{
   ...
   SubShader {
      ...
      fixed4 frag(v2f_img i) : SV_Target
      {
         ...
         float len = sqrt( finalNorm.x * finalNorm.x + finalNorm.y * finalNorm.y + 1 );
         finalNorm.z = 1.0 / len;
         
         float3 v3 = saturate(finalNorm.xyz);
         
         finalNorm = fixed4(v3.x, v3.y, v3.z, 1);
